...
public class ReactiveStreamExercise6 {

  public static void main(String[] args) throws IOException {

    // Use ReactiveSources.unresponsiveFlux() and ReactiveSources.unresponsiveMono()
    Flux<String> unresponsiveFlux = ReactiveStreamData.unresponsiveFlux();
    Mono<String> unresponsiveMono = ReactiveStreamData.unresponsiveMono();
